...
| 5   | `apps/client/src/styles/styles.scss`                                    | MODIFY      | Add `@import 'angular-gridster2/css/gridster.css';` so gridster's base CSS is loaded for cell-position computation (AAP § 0.6.1.8).                                 |
