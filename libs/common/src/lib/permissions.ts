...
export const permissions = {
  ...
  readAiRebalancing: 'readAiRebalancing',
  readDashboardLayout: 'readDashboardLayout',
  readFinancialProfile: 'readFinancialProfile',
  ...
  triggerSnowflakeSync: 'triggerSnowflakeSync',
  updateAccount: 'updateAccount',
  updateAccess: 'updateAccess',
  updateActivity: 'updateActivity',
  updateAuthDevice: 'updateAuthDevice',
  updateDashboardLayout: 'updateDashboardLayout',
  updateFinancialProfile: 'updateFinancialProfile',
  ...
  switch (aRole) {
    case 'ADMIN':
      return [
        ...
        permissions.readAiChat,
        permissions.readAiPrompt,
        permissions.readAiRebalancing,
